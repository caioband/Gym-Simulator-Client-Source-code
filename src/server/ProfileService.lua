...
local ProfileStore = {
	--[[
		...
		_global_data_store = global_data_store, -- [GlobalDataStore] -- Object returned by DataStoreService:GetDatstreamingenabledstreamingenabledaStore(_profile_store_name)
